  ...
  const filteredCreators = useMemo(() => {
    return creators.filter((creator) => {
      const matchesSearch =
        ...
        (creator.talentRightsId || creator.creatorRightsId || '').toLowerCase().includes(searchQuery.toLowerCase()) ||
        creator.email.toLowerCase().includes(searchQuery.toLowerCase())

      const matchesType = typeFilter === "all" || (creator.talentType || creator.creatorType) === typeFilter
